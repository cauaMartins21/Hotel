...
$sql ="INSERT INTO recepcionista
           ( email, nome_completo, cpf, endereco, telefone, rg, login, senha, confirmacao_senha, horario_trabalho)
        VALUE
           ('$email', '$nome_completo', '$cpf', '$endereco', '$telefone', '$rg', '$login', '$senha', '$confirmacao_senha', '$horario_trabalho')";
...
<link rel="stylesheet" href="css/bootstrap.min.css">
  ...
  body {
    ...
    <body>
        ...
        <div class="container" >
        <form action="Cadastro_Recepcionista.php" method="POST">

        <h1 class="text-center">Cadastro de Recepcionista</h1>
...
<div class="col-5">
    ...
    <input type="text" class="form-control" placeholder="Confirme seu Endereço" name="endereco" name="endereco" >
    </div>
            </div>
            ...
            <div class="row" >
                ...
                <div class="col">
                <label>RG</label>
                <input type="text" class="form-control" placeholder="Informe o Seu RG" name="rg" >
                </div>
                
                <div class="col-5">
                    <label>Horário de Trabalho</label>
                    <input type="time" class="form-control" placeholder="Horário de Trabalho" name="horario_trabalho" >
                    </div>
             </div>
            ...
            <div class="col-4">
              ...
              <label>CPF</label>
              <input type="number" class="form-control" placeholder="CPF(somente números)" pattern="[0-9]{11}" name="cpf" >
              </div>
            ...
            <div class="row">
              <div class="col-6">
                ...
                <input type="email" class="form-control" placeholder="Insira seu Email completo" name="email" >
              </div>
